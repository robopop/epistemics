...
public class EpistemicAppraisalDeriverNodeFactory implements DeriverNodeFactory<EpistemicAppraisalDeriverNode> {
    ...
    @Override
    public EpistemicAppraisalDeriverNode createDeriverNode(WorkingMemory workingMemory, Graph<Concept, Association> beliefSystemGraph, MentalWorldEngine.Logger logger) {
