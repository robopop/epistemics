 ...
 */
package selemca.epistemics.mentalworld.beliefsystemadmin.config;
...
@ComponentScan({"selemca.epistemics.mentalworld.beliefsystemadmin.dbaccess", "selemca.epistemics.mentalworld.beliefsystemadmin.importexport"})
public class BeliefSystemAdminConfig {
